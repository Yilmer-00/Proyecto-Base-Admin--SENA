    ...
    <div className="max-w-[800px] mx-auto mt-[30px] px-4">
      ...
      <div className="bg-white shadow-md rounded-lg overflow-hidden border border-gray-100">
        ...
        <div className="bg-[#39A900] text-white px-6 py-4">
          <h4 className="text-lg font-bold m-0">🔗 Asignar Instructor a un Curso</h4>
        </div>

        <div className="p-6 bg-gray-50">
          <form onSubmit={handleSubmit}>
            {/* Sección: Datos de la Vinculación */}
            <h5 className="text-[#39A900] font-semibold text-base mb-4 border-b border-gray-200 pb-2">
