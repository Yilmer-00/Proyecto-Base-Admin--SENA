    ...
    return (
        <div className="max-w-[800px] mx-auto mt-[30px] px-4">
            ...
            <div className="flex justify-between items-center mb-4">
                ...
                <span className="text-gray-500 font-bold">Módulo de Cursos</span>
            </div>
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden border border-gray-100">
                ...
                <div className="bg-[#39A900] text-white px-6 py-4">
                    <h4 className="text-lg font-bold m-0">➕ Registrar Nuevo Curso</h4>
                </div>
                ...
                <div className="p-6 bg-gray-50">
                    <form onSubmit={handleSubmit}>
                        ...
                        <h5 className="text-[#39A900] font-semibold text-base mb-4 border-b border-gray-200 pb-2">📖 Identificación del Curso</h5>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            {/* Número de Curso */}
                            <div>
                                <label className="block text-sm font-bold text-gray-500 mb-2">Número de Curso (Ficha):</label>
                                <input
                                    type="text"
                                    name="course_number"
                            ...
                            {/* Día / Jornada */}
                            <div>
                                <label className="block text-sm font-bold text-gray-500 mb-2">Día / Jornada:</label>
                                <input
                                    type="text"
                                    name="day"
                                    value={formData.day}
                        ...
                        <h5 className="text-[#39A900] font-semibold text-base mb-4 border-b border-gray-200 pb-2">📍 Clasificación y Ubicación</h5>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            {/* Selector de Área */}
                            <div>
                                <label className="block text-sm font-bold text-gray-500 mb-2">Área Relacionada:</label>
                                <select
                                    name="area_id"
