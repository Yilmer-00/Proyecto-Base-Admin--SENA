...
const CourseList = ({ courses = [], onDelete, successMessage }) => {
  return (
    <div
      className="container"
    ...
    >
      ...
      <div className="card shadow border-0">
        ...
        >
          <h4 className="mb-0 fw-bold">📋 Listado de Cursos</h4>
        </div>
                ...
                {courses && courses.length > 0 ? (
                  courses.map((course) => (
                    <tr key={course.id}>
                      ...
                      <td className="text-secondary small">
                        ...
                        {course.trainig_center?.name || "N/A"}
                      </td>
                      ...
                      <td className="pe-4 text-center">
                        <div className="d-flex gap-2 justify-content-center align-items-center">
                          ...
                          <Link
                            to={`/course/${course.id}`}
                            className="btn btn-primary btn-sm shadow-sm text-decoration-none"
                          >
                            Mostrar
                          </Link>
                  ...
                  <tr>
                    <td colSpan="6" className="text-center py-5 text-muted">
                      <i className="fas fa-graduation-cap fs-2 mb-3 d-block text-secondary"></i>
